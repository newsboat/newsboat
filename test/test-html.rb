...
Tuitest.init
verifier = Tuitest::Verifier.new("test-html.rb.log")
...
verifier.expect(3, 0, "Author: ak@newsbeuter.org (Andreas Krennmair)")
verifier.expect(4, 0, "Link: http://testbed.newsbeuter.org/htmlitem1.html")
verifier.expect(5, 0, "Date: Sat, 30 Aug 2008 10:40:10")
verifier.expect(7, 0, "[1]normal link")
