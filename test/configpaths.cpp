	...
	"[ConfigPaths]")
{
	...
	REQUIRE(paths.search_history_file() == newsboat_dir.join("history.search"));
	REQUIRE(paths.cmdline_history_file() == newsboat_dir.join("history.cmdline"));
}
	...
	"[ConfigPaths]")
{
	...
	const auto check = [&]() {
		...
		REQUIRE(paths.search_history_file() == data_dir.join("history.search"));
		REQUIRE(paths.cmdline_history_file() == data_dir.join("history.cmdline"));
	};
