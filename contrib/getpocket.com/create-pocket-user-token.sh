...
output=`wget --post-data '{ "consumer_key":"19002-18d9a9028a5ae783a9caabcd", "redirect_uri":"https://github.com/andreashappe/newsbeuter/blob/getpocket/contrib/getpocket.com/after_authentication.md"}' --header="Content-Type: application/json; charset=UTF-8" --header "X-Accept: application/json" "https://getpocket.com/v3/oauth/request" -O - 2>/dev/null`
...
AUTH_URL="https://getpocket.com/auth/authorize?request_token=$TMP_TOKEN&redirect_uri=https://github.com/andreashappe/newsbeuter/blob/getpocket/contrib/getpocket.com/after_authentication.md"
