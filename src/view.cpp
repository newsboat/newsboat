...
{
	std::string upkey("** ");
	upkey.append(utils::join(keys->getkeys(OP_SK_UP, fa->id()), " "));
	std::string downkey("** ");
	downkey.append(utils::join(keys->getkeys(OP_SK_DOWN, fa->id()), " "));
	...
	pgupkey.append(utils::join(keys->getkeys(OP_SK_PGUP, fa->id()), " "));
	pgdownkey.append(utils::join(keys->getkeys(OP_SK_PGDOWN, fa->id()), " "));

	fa->get_form()->set("bind_page_up", pgupkey);
	fa->get_form()->set("bind_page_down", pgdownkey);

	std::string homekey("** ");
	homekey.append(utils::join(keys->getkeys(OP_SK_HOME, fa->id()), " "));
	std::string endkey("** ");
	endkey.append(utils::join(keys->getkeys(OP_SK_END, fa->id()), " "));
