...
std::string
fmtstr_formatter::do_format(const std::string& fmt, unsigned int width)
{
	std::string result;
	if (fmt.length() > 0) {
...
std::wstring
fmtstr_formatter::do_wformat(const std::wstring& wfmt, unsigned int width)
{
	std::wstring result;
	unsigned int i;
