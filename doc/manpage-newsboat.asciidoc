...
--cleanup::
        Remove unreferenced entries from the cache. Feeds and their articles
        will be removed if the feedurl is no longer in the _urls_ file. If 
        the _delete-read-articles-on-quit_ configuration is set, read articles
